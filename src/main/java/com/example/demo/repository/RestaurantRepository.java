...
public interface RestaurantRepository extends JpaRepository<Restaurant, Integer> {
	...
	@Query("SELECT r FROM Restaurant r JOIN r.zone z JOIN z.ville v WHERE v.nom = :ville And z.nom = :zone")
	List<Restaurant> findAllByVilleAndZone(@Param("ville") String ville,@Param("zone") String zone);
